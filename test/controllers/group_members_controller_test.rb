...
class GroupMembersControllerTest < ActionController::TestCase
  ...
  test "should create group_member" do
    assert_difference('GroupMember.count') do
      post :create, group_member: { created_by: @group_member.created_by, created_date: @group_member.created_date, group_id: @group_member.group_id, updated_by: @group_member.updated_by, updated_date: @group_member.updated_date, user_id: @group_member.user_id }
    end
  ...
  test "should update group_member" do
    patch :update, id: @group_member, group_member: { created_by: @group_member.created_by, created_date: @group_member.created_date, group_id: @group_member.group_id, updated_by: @group_member.updated_by, updated_date: @group_member.updated_date, user_id: @group_member.user_id }
    assert_redirected_to group_member_path(assigns(:group_member))
  end
